...
TypeId TypeIdFromString(string type) {
	if (type == "BOOL")
		return TypeId::BOOL;
	else if (type == "INT8")
		return TypeId::INT8;
...
SQLTypeId SQLTypeIdFromString(string id) {
    if (id == "BOOLEAN")
        ...
        return SQLTypeId::TIME;
    else if (id == "TIMESTAMP")
        return SQLTypeId::TIMESTAMP;
    else if (id == "FLOAT")
        return SQLTypeId::FLOAT;
    else if (id == "DOUBLE")
        ...
        return SQLTypeId::CHAR;
    else if (id == "NULL")
        return SQLTypeId::SQLNULL;
    else if (id == "ANY")
        return SQLTypeId::ANY;
    else if (id == "STRUCT")
        return SQLTypeId::STRUCT;
    else if (id == "LIST<?>")
        return SQLTypeId::LIST;
    else
