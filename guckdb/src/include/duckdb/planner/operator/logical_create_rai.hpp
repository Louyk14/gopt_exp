...
public:
    static constexpr const LogicalOperatorType TYPE = LogicalOperatorType::LOGICAL_CREATE_RAI;
...
public:
	LogicalCreateRAI(string name, TableCatalogEntry &table, RAIDirection rai_direction, vector<column_t> column_ids,
	    ...
	    : LogicalOperator(LogicalOperatorType::LOGICAL_CREATE_RAI), name(name), table(table), rai_direction(rai_direction),
