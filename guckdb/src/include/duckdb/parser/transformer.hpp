...
private:
    ...
    //! Transform a Postgres T_PGCreateEdgeStmt node into a CreateStatement
    unique_ptr<CreateStatement> TransformCreateRAI(duckdb_libpgquery::PGCreateRAIStmt &node);
	//! Transform a Postgres duckdb_libpgquery::T_PGCreateStmt node into a CreateStatement
