...
//                         DuckDB
//
// duckdb/execution/operator/join/physical_sip_join.hpp
//
//
//===----------------------------------------------------------------------===//
...
//! PhysicalHashJoin represents a hash loop join between two tables
    ...
    public:
        static constexpr const PhysicalOperatorType TYPE = PhysicalOperatorType::SIP_JOIN;

    public:
        PhysicalSIPJoin(LogicalOperator &op, unique_ptr<PhysicalOperator> left, unique_ptr<PhysicalOperator> right,
