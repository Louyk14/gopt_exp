...
PG_KEYWORD("directed", DIRECTED, RESERVED_KEYWORD)
...
PG_KEYWORD("pkfk", PKFK, RESERVED_KEYWORD)
...
PG_KEYWORD("rai", RAI, RESERVED_KEYWORD)
...
PG_KEYWORD("self", SELF, RESERVED_KEYWORD)
...
PG_KEYWORD("undirected", UNDIRECTED, RESERVED_KEYWORD)
